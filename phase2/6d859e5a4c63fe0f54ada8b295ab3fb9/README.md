1. Name of your Application: Without a name for the moment
2. Keywords: dinamic, fast, map, accurate.
3. Description of the datasets and function design:
Name: Affordable Rental Housing Developments
Link: https://catalog.data.gov/dataset/affordable-rental-housing-developments-ef5c2
...
Y
Are all these datasets from data.gov or data.indy.gov?
Y

4.Brief Description:
Is a first and very basic approximation of how to integrate the map and a dataset, how you use marks to show each place,use climate data, and css styles. 
