This app was created using Angular quickstart template from official page.

Of course its in initial state.. It will display diferent places around
the desired point in the future using google api and getting data from data.org

Each place has reputation and rent per week that would help any student
to choose the best option for his staying in Chicago, and the idea is to
show those places in map too and have a fancy front-end to people be confortable
using the app.
