/* Option controllers to filtering the houses in the map
option 1 refers to default */
var option1 = false;
var option2 = false;
var option3 = false;
var option4 = false;
var option5 = false;
var ready = false; // var used to control when crime dataset is loaded
var runtimes = 0; //Control the number of times that user clicked the go button.
var medianUnits; // saves the median unit values of homes.
var unit10; // 10% of medianUnits
var washedData = []; //rental data
var crimesData = []; //crimes data
var nearCrimes = []; // save near crimes to a specific house in map
var fireStationsData = []; //fire stations data, same for the next array declarations
...
var directionsDisplay; //variable used to get the distance of two points
...
var biciIcon = 'icons/bike.png'; //icon for bici stations
var libIcon = 'icons/library.png'; //icon for libraries
var parkIcon = 'icons/park.png'; //icon for parks
var cartIcon = 'icons/food.png'; //icons for produce foods
var cases; // option cases
var thisYear = new Date().getFullYear(); //actual year.
//console.log(thisYear);
var beText = []; //This array contains text information about Chicago City
var displayText ; //var used when display the Chicago tips
var viewedTimes = 0; //number of times user clicked the view info button
...
function criminalData(){
  ...
  .done (function(result){
    ...
    //In Order: iucr : 11 ; name : 12; latitude: 22; longitude: 23;
    crimesData=[];
    var i=0;
...
//function to display Chicago tips in welcome page, in aleatory positions
...
//Function to collect nearest places to a specific point
...
// find near positions, but not display in any map. 
