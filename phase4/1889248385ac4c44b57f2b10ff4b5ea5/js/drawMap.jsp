...
function dataSetMarkets(map){
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            //document.getElementById("zillowP").innerHTML = washedDataM[key][11]; 
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for (var i = 0; i<46; i++) {
                ...
                //document.getElementById("zillowP").innerHTML = json.data[i][8];
                //Property type
       ...
       infowindow.setContent("Not available yet");
