function update(){
    ...
    document.getElementById("paragraph4").style.fontSize = firstFontSize+"pt";
    ...
    document.getElementById("hD1").style.fontSize = firstFontSize+"pt";
    document.getElementById("hD2").style.fontSize = firstFontSize+"pt";
    document.getElementById("hD3").style.fontSize = firstFontSize+"pt";
    document.getElementById("description").style.fontSize = firstFontSize+"pt";
    document.getElementById("maxTmp").style.fontSize = firstFontSize+"pt";
    document.getElementById("minTmp").style.fontSize = firstFontSize+"pt";
}
