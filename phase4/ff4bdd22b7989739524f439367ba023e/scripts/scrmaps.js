...
//     $.ajax({
//         type: 'GET',
//         url: 'https://www.zillow.com/webservice/GetDeepSearchResults.htm?zws-id=X1-ZWz1fqgaxkx98r_2ca3z&address=3300+W.+Maypole+Ave.&citystatezip=Chicago+IL&rentzestimate=true',
...
//             console.log($(data).find('rentzestimate:first').find('amount:first').text());
//             console.log($(data).find('bathrooms:first').text().split('.')[0]);
//             console.log($(data).find('bedrooms:first').text().split('.')[0]);
//             console.log(data);
//         }
//     });
// }
