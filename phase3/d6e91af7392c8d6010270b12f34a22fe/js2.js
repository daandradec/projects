...
function initMap() {
    ...
    google.maps.event.addListener(marker[0], 'click', function () {
        ...
        document.getElementById("time").innerHTML = "<b>Timing</b>: " + market.Season1Time[0];
    ...
    google.maps.event.addListener(marker[1], 'click', function () {
        ...
        document.getElementById("time").innerHTML = "<b>Timing</b>: " + market.Season1Time[1];
        ...
        document.getElementById("time").innerHTML = "<b>Timing</b>: " + market.Season1Time[2];
        ...
        document.getElementById("time").innerHTML = "<b>Timing</b>: " + market.Season1Time[3];
