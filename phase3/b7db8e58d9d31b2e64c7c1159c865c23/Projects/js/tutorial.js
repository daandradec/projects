                    ...
                    if (status === google.maps.ElevationStatus.OK) {
                        ...
                        $.each(results, function (key, value) {
                            ...
                            google.maps.event.addListener(markers[key], 'click', function () {
                                ...
                                array[3] = (10 - (Math.sqrt(Math.pow((lat_university - washedData[i][0]), 2) + Math.pow((lng_university - washedData[i][1]), 2)) * 35)) / 10;
                                i = i + 1;
...
//document.write('<p><p>' + lat_university, lng_university + '</p></p>');
